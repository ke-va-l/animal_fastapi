...
from professional.database import get_db
from professional.schemas import QuestionCreate, QuestionResponse
from professional.crud import create_question, get_questions, get_question, update_question, delete_question
